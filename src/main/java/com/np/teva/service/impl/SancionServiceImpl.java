...
public class SancionServiceImpl implements SancionService {
    ...
    public int rechazarSancionesDuplicadas(Date fec_sancion, int cod_zona) throws AccesoDatosException {
        ...
        try {
            ...
            throw new AccesoDatosException("MyBatisSystemException running rechazarSancionesDuplicadas", mex);
        } catch (DataAccessException dex) {
            throw new AccesoDatosException("DataAccessException running rechazarSancionesDuplicadas", dex);
        }
